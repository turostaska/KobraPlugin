...
public class KobraConjunctionImpl extends ASTWrapperPsiElement implements KobraConjunction {

  public KobraConjunctionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KobraConj> getConjList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraConj.class);
  }
  ...
  @Override
  @NotNull
  public List<KobraEquality> getEqualityList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraEquality.class);
  }

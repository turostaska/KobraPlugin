...
public class KobraSimpleIdentifierImpl extends ASTWrapperPsiElement implements KobraSimpleIdentifier {

  public KobraSimpleIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class KobraControlStructureBodyImpl extends ASTWrapperPsiElement implements KobraControlStructureBody {

  public KobraControlStructureBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KobraStatement getStatement() {
    return findChildByClass(KobraStatement.class);
  }

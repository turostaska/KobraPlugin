...
public class KobraStringLiteralImpl extends ASTWrapperPsiElement implements KobraStringLiteral {

  public KobraStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KobraStringLiteral getStringLiteral() {
    return findNotNullChildByClass(KobraStringLiteral.class);
  }

...
public class KobraExclNoWsImpl extends ASTWrapperPsiElement implements KobraExclNoWs {

  public KobraExclNoWsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitExclNoWs(this);
  }

...
public class KobraProtectedImpl extends ASTWrapperPsiElement implements KobraProtected {

  public KobraProtectedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitProtected(this);
  }

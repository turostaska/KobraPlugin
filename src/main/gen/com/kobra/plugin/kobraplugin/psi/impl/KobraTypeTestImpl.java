...
public class KobraTypeTestImpl extends ASTWrapperPsiElement implements KobraTypeTest {

  public KobraTypeTestImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraIsOperator getIsOperator() {
    return findNotNullChildByClass(KobraIsOperator.class);
  }

...
public class KobraImportAliasImpl extends ASTWrapperPsiElement implements KobraImportAlias {

  public KobraImportAliasImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KobraAs getAs() {
    return findNotNullChildByClass(KobraAs.class);
  }

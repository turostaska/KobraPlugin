...
public class KobraClassMemberDeclarationImpl extends ASTWrapperPsiElement implements KobraClassMemberDeclaration {

  public KobraClassMemberDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraDeclaration getDeclaration() {
    return findNotNullChildByClass(KobraDeclaration.class);
  }

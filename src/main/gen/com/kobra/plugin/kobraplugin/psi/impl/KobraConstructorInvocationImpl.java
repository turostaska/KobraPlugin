...
public class KobraConstructorInvocationImpl extends ASTWrapperPsiElement implements KobraConstructorInvocation {

  public KobraConstructorInvocationImpl(@NotNull ASTNode node) {
    super(node);
  }

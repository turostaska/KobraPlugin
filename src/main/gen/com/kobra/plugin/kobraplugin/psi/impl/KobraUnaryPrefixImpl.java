...
public class KobraUnaryPrefixImpl extends ASTWrapperPsiElement implements KobraUnaryPrefix {

  public KobraUnaryPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitUnaryPrefix(this);
  }
  ...
  @Override
  @NotNull
  public KobraPrefixUnaryOperator getPrefixUnaryOperator() {
    return findNotNullChildByClass(KobraPrefixUnaryOperator.class);
  }

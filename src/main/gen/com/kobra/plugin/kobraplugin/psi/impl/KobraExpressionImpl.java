...
public class KobraExpressionImpl extends ASTWrapperPsiElement implements KobraExpression {

  public KobraExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraDisjunction getDisjunction() {
    return findNotNullChildByClass(KobraDisjunction.class);
  }

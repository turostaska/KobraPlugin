...
public class KobraDelimitedCommentImpl extends ASTWrapperPsiElement implements KobraDelimitedComment {

  public KobraDelimitedCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitDelimitedComment(this);
  }

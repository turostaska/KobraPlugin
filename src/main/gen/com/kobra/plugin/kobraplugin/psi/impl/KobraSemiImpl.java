...
public class KobraSemiImpl extends ASTWrapperPsiElement implements KobraSemi {

  public KobraSemiImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KobraSemicolon getSemicolon() {
    return findChildByClass(KobraSemicolon.class);
  }

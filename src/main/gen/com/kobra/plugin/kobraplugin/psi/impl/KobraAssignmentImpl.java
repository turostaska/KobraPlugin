...
public class KobraAssignmentImpl extends ASTWrapperPsiElement implements KobraAssignment {

  public KobraAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KobraAssignment getAssignment() {
    return findNotNullChildByClass(KobraAssignment.class);
  }

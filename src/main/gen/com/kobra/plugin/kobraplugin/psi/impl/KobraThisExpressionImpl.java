...
public class KobraThisExpressionImpl extends ASTWrapperPsiElement implements KobraThisExpression {

  public KobraThisExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraThis getThis() {
    return findNotNullChildByClass(KobraThis.class);
  }

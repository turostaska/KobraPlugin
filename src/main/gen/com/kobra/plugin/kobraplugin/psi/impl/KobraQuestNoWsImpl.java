...
public class KobraQuestNoWsImpl extends ASTWrapperPsiElement implements KobraQuestNoWs {

  public KobraQuestNoWsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitQuestNoWs(this);
  }

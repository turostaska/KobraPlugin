...
public class KobraClassBodyImpl extends ASTWrapperPsiElement implements KobraClassBody {

  public KobraClassBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraClassMemberDeclarations getClassMemberDeclarations() {
    return findNotNullChildByClass(KobraClassMemberDeclarations.class);
  }

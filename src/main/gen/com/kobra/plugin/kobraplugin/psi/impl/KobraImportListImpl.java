...
public class KobraImportListImpl extends ASTWrapperPsiElement implements KobraImportList {

  public KobraImportListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KobraImportHeader> getImportHeaderList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraImportHeader.class);
  }

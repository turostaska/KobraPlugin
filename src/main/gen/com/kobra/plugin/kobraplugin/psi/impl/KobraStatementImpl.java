...
public class KobraStatementImpl extends ASTWrapperPsiElement implements KobraStatement {

  public KobraStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public KobraDeclaration getDeclaration() {
    return findChildByClass(KobraDeclaration.class);
  }

...
public class KobraClassParametersImpl extends ASTWrapperPsiElement implements KobraClassParameters {

  public KobraClassParametersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitClassParameters(this);
  }
  ...
  @Override
  @NotNull
  public List<KobraClassParameter> getClassParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraClassParameter.class);
  }

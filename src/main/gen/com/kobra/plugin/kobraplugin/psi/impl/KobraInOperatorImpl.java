...
public class KobraInOperatorImpl extends ASTWrapperPsiElement implements KobraInOperator {

  public KobraInOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KobraIn getIn() {
    return findChildByClass(KobraIn.class);
  }

  @Override
  @Nullable
  public KobraNotIn getNotIn() {
    return findChildByClass(KobraNotIn.class);
  }

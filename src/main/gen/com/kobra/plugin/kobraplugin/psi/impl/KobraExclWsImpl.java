...
public class KobraExclWsImpl extends ASTWrapperPsiElement implements KobraExclWs {

  public KobraExclWsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitExclWs(this);
  }
  ...
  public KobraHidden getHidden() {
    return findNotNullChildByClass(KobraHidden.class);
  }

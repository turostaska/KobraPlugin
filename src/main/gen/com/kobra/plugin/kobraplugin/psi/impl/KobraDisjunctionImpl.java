...
public class KobraDisjunctionImpl extends ASTWrapperPsiElement implements KobraDisjunction {

  public KobraDisjunctionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KobraDisj> getDisjList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraDisj.class);
  }
  ...
  @Override
  @NotNull
  public List<KobraConjunction> getConjunctionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraConjunction.class);
  }

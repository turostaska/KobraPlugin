...
public class KobraFunctionParametersImpl extends ASTWrapperPsiElement implements KobraFunctionParameters {

  public KobraFunctionParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KobraFunctionParameter> getFunctionParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraFunctionParameter.class);
  }

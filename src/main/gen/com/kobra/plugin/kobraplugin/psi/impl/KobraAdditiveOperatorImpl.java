...
public class KobraAdditiveOperatorImpl extends ASTWrapperPsiElement implements KobraAdditiveOperator {

  public KobraAdditiveOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

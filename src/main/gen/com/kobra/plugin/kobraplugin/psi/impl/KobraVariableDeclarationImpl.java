...
public class KobraVariableDeclarationImpl extends ASTWrapperPsiElement implements KobraVariableDeclaration {

  public KobraVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

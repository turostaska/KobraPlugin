...
public class KobraElvisImpl extends ASTWrapperPsiElement implements KobraElvis {

  public KobraElvisImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitElvis(this);
  }
  ...
  @Override
  @NotNull
  public KobraQuestNoWs getQuestNoWs() {
    return findNotNullChildByClass(KobraQuestNoWs.class);
  }

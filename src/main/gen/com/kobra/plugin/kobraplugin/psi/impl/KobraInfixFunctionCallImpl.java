...
public class KobraInfixFunctionCallImpl extends ASTWrapperPsiElement implements KobraInfixFunctionCall {

  public KobraInfixFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<KobraRangeExpression> getRangeExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, KobraRangeExpression.class);
  }

...
public class KobraPrivate_Impl extends ASTWrapperPsiElement implements KobraPrivate_ {

  public KobraPrivate_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KobraVisitor visitor) {
    visitor.visitPrivate_(this);
  }

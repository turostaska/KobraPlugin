...
public class KobraCallSuffixImpl extends ASTWrapperPsiElement implements KobraCallSuffix {

  public KobraCallSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KobraValueArguments getValueArguments() {
    return findNotNullChildByClass(KobraValueArguments.class);
  }

...
public class KobraTypeImpl extends ASTWrapperPsiElement implements KobraType {

  public KobraTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public KobraQuest getQuest() {
    return findChildByClass(KobraQuest.class);
  }
